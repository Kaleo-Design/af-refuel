...
import 'nav_side02_model.dart';
export 'nav_side02_model.dart';

class NavSide02Widget extends StatefulWidget {
  const NavSide02Widget({
    super.key,
  ...
  @override
  State<NavSide02Widget> createState() => _NavSide02WidgetState();
}

class _NavSide02WidgetState extends State<NavSide02Widget>
    with TickerProviderStateMixin {
  late NavSide02Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NavSide02Model());
                    ...
                    children: [
                      wrapWithModel(
                        ...
                        child: UserInfoWidget(
                          showName: FFAppState().navOpen == true,
                          name: 'Jeremy Lin',
                          imageSize: valueOrDefault<int>(
                            FFAppState().navOpen == true ? 50 : 36,
                            48,
                          ),
                          titleColor:
