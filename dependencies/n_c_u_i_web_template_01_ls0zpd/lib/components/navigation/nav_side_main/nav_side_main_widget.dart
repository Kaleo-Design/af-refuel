import '/components/dropdowns/dropdown_user_details/dropdown_user_details_widget.dart';
...
import 'nav_side_main_model.dart';
export 'nav_side_main_model.dart';

class NavSideMainWidget extends StatefulWidget {
  const NavSideMainWidget({
    super.key,
  ...
  @override
  State<NavSideMainWidget> createState() => _NavSideMainWidgetState();
}

class _NavSideMainWidgetState extends State<NavSideMainWidget>
    with TickerProviderStateMixin {
  late NavSideMainModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NavSideMainModel());
    ...
    return Shortcuts(
      ...
      child: Actions(
        ...
        child: Focus(
          ...
          focusNode: _model.navSideMainShortcutsFocusNode,
          child: GestureDetector(
              onTap: () => _model.navSideMainShortcutsFocusNode!.canRequestFocus
                  ? FocusScope.of(context)
                      .requestFocus(_model.navSideMainShortcutsFocusNode)
                              ...
                              MouseRegion(
                                ...
                                child: Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      context.pushNamed(
                                        MainNotificationsWidget.routeName,
                                        extra: <String, dynamic>{
                                          kTransitionInfoKey: TransitionInfo(
                                            hasTransition: true,
                                            transitionType:
