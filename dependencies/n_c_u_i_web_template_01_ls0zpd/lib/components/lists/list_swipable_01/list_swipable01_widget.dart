...
import 'list_swipable01_model.dart';
export 'list_swipable01_model.dart';

class ListSwipable01Widget extends StatefulWidget {
  const ListSwipable01Widget({
    super.key,
    String? name,
  ...
  @override
  State<ListSwipable01Widget> createState() => _ListSwipable01WidgetState();
}

class _ListSwipable01WidgetState extends State<ListSwipable01Widget>
    with TickerProviderStateMixin {
  late ListSwipable01Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListSwipable01Model());
                    ...
                    child: Padding(
                      ...
                      child: GestureDetector(
                        ...
                        onHorizontalDragDown: (details) async {
                          if (details.globalPosition.dx >= 0.3) {
                            // start_animation
                            if (animationsMap[
                                    'containerOnActionTriggerAnimation'] !=
                                null) {
                            ...
                            // update_location_to_0.3
                            _model.swipable = true;
                            safeSetState(() {});
                            // animate_scale
                            if (animationsMap[
                                    'transformOnActionTriggerAnimation'] !=
