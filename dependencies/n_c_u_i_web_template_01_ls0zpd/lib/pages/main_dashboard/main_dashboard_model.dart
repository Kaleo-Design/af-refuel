...
import '/components/ui_toggle_basic_widget.dart';
...
class MainDashboardModel extends FlutterFlowModel<MainDashboardWidget> {
  ...
  // Model for ui_toggle_basic component.
  late UiToggleBasicModel uiToggleBasicModel;
  ...
  void initState(BuildContext context) {
    ...
    listDoubleAvatar01Model7 =
        createModel(context, () => ListDoubleAvatar01Model());
    weeklyCardModel = createModel(context, () => WeeklyCardModel());
  }
