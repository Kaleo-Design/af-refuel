...
import 'onboarding_profile_creation_model.dart';
export 'onboarding_profile_creation_model.dart';

class OnboardingProfileCreationWidget extends StatefulWidget {
  const OnboardingProfileCreationWidget({super.key});

  static String routeName = 'onboarding_profile_creation';
  static String routePath = '/onboardingProfileCreation';

  @override
  State<OnboardingProfileCreationWidget> createState() =>
      _OnboardingProfileCreationWidgetState();
}

class _OnboardingProfileCreationWidgetState
    extends State<OnboardingProfileCreationWidget>
    with TickerProviderStateMixin {
  late OnboardingProfileCreationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OnboardingProfileCreationModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.gender = FFAppState().onboardingData.gender;
      safeSetState(() {});
    });

    _model.usernameTextController ??=
        TextEditingController(text: FFAppState().onboardingData.name);
    _model.usernameFocusNode ??= FocusNode();
    _model.usernameFocusNode!.addListener(() => safeSetState(() {}));
    _model.locationTextController ??=
        TextEditingController(text: FFAppState().onboardingData.location);
              ...
              Padding(
                ...
                child: LinearPercentIndicator(
                  percent: n_c_u_i_web_template_01_ls0zpd_functions
                      .getProgressBarValue(7, _model.pageViewCurrentIndex)!,
                  lineHeight: 12.0,
                  animation: true,
                  ...
                  child: PageView(
                    controller: _model.pageViewController ??= PageController(
                        initialPage: max(
                            ...
                            min(
                                valueOrDefault<int>(
                                  FFAppState().onboardingData.currentStep,
                                  0,
                                ),
                                6))),
                    ...
                    children: [
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      hintText: 'i.e. John Macintosh Jones...',
                                  ...
                                  wrapWithModel(
                                    model: _model.listSelectModel1,
                                    updateCallback: () => safeSetState(() {}),
                                    updateOnChange: true,
                                    child: ListSelectWidget(
                                      title: 'Male',
                                      id: '0',
                                      subtitle: 'Your biological sex is male',
                                      selected: _model.gender == 'Male',
                                      showSubTitle: true,
                                      action: () async {
                                        _model.gender = 'Male';
                                        safeSetState(() {});
                                  ...
                                  wrapWithModel(
                                    model: _model.listSelectModel2,
                                    updateCallback: () => safeSetState(() {}),
                                    updateOnChange: true,
                                    child: ListSelectWidget(
                                      title: 'Female',
                                      id: '1',
                                      subtitle: 'Your biological sex is female',
                                      selected: _model.gender == 'Female',
                                      showSubTitle: true,
                                      action: () async {
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Please enter the details of your current military status.',
                                    textAlign: TextAlign.start,
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                  ...
                                  wrapWithModel(
                                    model: _model.militaryStatusModel,
                                    updateCallback: () => safeSetState(() {}),
                                    updateOnChange: true,
                                    child: ListSelectWidget(
                                      ...
                                      subtitle: valueOrDefault<String>(
                                        FFAppState()
                                            ...
                                            .deploymentStatus
                                            .description,
                                        'Please select your deployment status.',
                                      ),
                                      showSubTitle: true,
                                      action: () async {
                                            ...
                                            return GestureDetector(
                                              ...
                                              child: Padding(
                                                ...
                                                child: ModalSimpleWidget(
                                                  ...
                                                  subtitle:
                                                      'Please select the status that closely represents your status below.',
                                                  widgetContent: () =>
                      ...
                      Column(
                        ...
                        children: [
                          Expanded(
                            child: wrapWithModel(
                              model: _model.viewGoalsOnboardingModel,
                              updateCallback: () => safeSetState(() {}),
                              updateOnChange: true,
                              child: ViewGoalsOnboardingWidget(),
                            ),
                          ),
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                FFAppState().updateOnboardingDataStruct(
                                  (e) => e
                                    ..currentStep = _model.pageViewCurrentIndex,
                                );
                                safeSetState(() {});
                                await _model.pageViewController?.nextPage(
                                  duration: Duration(milliseconds: 300),
                                      ...
                                      children: [
                                        ...
                                        wrapWithModel(
                                          ...
                                          child: UiHeaderSubWidget(
                                            ...
                                            subtitle:
                                                'Please let us know more about you to show you the most relavent content.',
                                            header: true,
                                          ),
                                        ),
                                        wrapWithModel(
