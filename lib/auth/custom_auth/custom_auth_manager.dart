...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    refuelAuthUserSubject.add(
      RefuelAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<RefuelAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  RefuelAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = RefuelAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    refuelAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
